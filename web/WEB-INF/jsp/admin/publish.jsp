...
<div style="background-color: rgb(47,53,63);width: 300px;min-height: 100%;float: left;display: block" id="left1">
    ...
    <ul>
        ...
        <a href="/article/publishBefore" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li style="background-color: rgb(39,44,53)"><i class="fa fa-pencil-square-o">&emsp;</i>发布文章</li>
        </a>
...
<div style="background-color: rgb(47,53,63);width: 100px;min-height: 100%;float: left;display: none" id="left2">
    ...
    <ul style="width: 100px;font-size: 30px">
        <a href="/indexServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li><i class="fa fa-home">&emsp;</i></li>
        </a>
        <a href="/publishBeforeServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li style="background-color: rgb(39,44,53)"><i class="fa fa-pencil-square-o">&emsp;</i></li>
        </a>
        <a href="/articleServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li><i class="fa fa-list">&emsp;</i></li>
        </a>
        <a href="/linkServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li><i class="fa fa-link">&emsp;</i></li>
        </a>
        <a href="/categoryServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li><i class="fa fa-tags">&emsp;</i></li>
        </a>
        <a href="/fileServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li><i class="fa fa-file">&emsp;</i></li>
        </a>
        <a href="/messageServlet" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li><i class="fa fa-comments">&emsp;</i></li>
        </a>
        <a href="/WEB-INF/jsp/admin/setting.jsp" style="cursor: url('/image/hand_page_05.png'),auto;">
...
<div style="background-color: white;width: auto;min-height: 100%;">
    ...
    <div style="width: auto;height: 842px;background-color: rgb(245,245,245)">
        ...
        <form action="/article/doPublish" method="post" id="articleForm">
            <input type="text" placeholder="请输入标题" name="title">
            <input type="text" placeholder="请输入访问路径" name="url">
            <div id="tag">
                <div style="float: right"><input type="text" style="margin: 0px" placeholder="请输入文章标签" id="tagInput">
                </div>
            </div>
            ...
            <div id="show" style="float: left;width: 750px;height: 500px;background-color: white;margin-left: 35px">
            </div>
            <br>
            <div id="buttons">
