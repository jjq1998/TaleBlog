...
<head>
    ...
    <link rel="stylesheet" href="/css/admin/link.css">
</head>
<body>
<div style="background-color: rgb(47,53,63);width: 300px;min-height: 100%;float: left;display: block" id="left1">
    ...
    <ul>
        ...
        <a href="/link/link" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li style="background-color: rgb(39,44,53)"><i class="fa fa-link">&emsp;</i>友链管理</li>
        </a>
...
<div style="background-color: rgb(47,53,63);width: 100px;min-height: 100%;float: left;display: none" id="left2">
    ...
    <ul style="width: 100px;font-size: 30px">
        ...
        <a href="/link/link" style="cursor: url('/image/hand_page_05.png'),auto;">
            <li style="background-color: rgb(39,44,53)"><i class="fa fa-link">&emsp;</i></li>
        </a>
        <a href="/category/categoryAndTag" style="cursor: url('/image/hand_page_05.png'),auto;">
...
<div style="background-color: white;width: auto;min-height: 100%;">
    ...
    <div style="width: auto;height: 842px;background-color: rgb(245,245,245)">
        <h2 style="color: rgb(145,145,145);line-height: 100px;padding-left: 330px" id="h2">友链管理</h2>
        <table>
            <tr>
                <th style="width: 500px">链接名称</th>
                <th style="width: 700px">链接地址</th>
            ...
            <c:forEach items="${requestScope.list}" var="link">
                <tr>
                    ...
                    <td><a href="/link/linkDelete?id=${link.id}"><input type="button" value="删除" style="width: 100px;height: 30px;border: 0px;color: white;background-color: #f05f5c"></a></td>
                </tr>
            </c:forEach>
        </table>
        <form action="/link/linkInseret">
            <table style="margin-top: 50px;text-align: left">
                <th colspan="3" style="width: 800px;height: 50px;background-color: #6e8cd7;color: white;padding-left: 30px">保存友链</th>
                <tr style="height: 80px">
                    <td style="border: 0;padding-left: 30px"><input type="text" placeholder="请输入链接名" name="name" style="height: 30px;width: 300px"></td>
                    <td style="border: 0;padding-left: 30px"><input type="text" placeholder="请输入连接地址" name="url" style="height: 30px;width: 300px"></td>
                    <td style="border: 0;padding-left: 30px"><input type="submit" value="保存友链" style="width: 100px;height: 30px;border: 0px;background-color: #41bd76;color: white"></td>
                </tr>
            </table>
        </form>
    </div>
